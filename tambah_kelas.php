				...
				<div style="margin-top:10px;">
					<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input name="nama_kelas" type="text" id="nama" class="form-control">
							</div>
						</div>
						...
						if (isset($_POST['simpan'])) {
							...
							mysql_query("insert into kelas (nama_kelas,wali_kelas) values ('$_POST[nama_kelas]','$_POST[wali_kelas]')");
