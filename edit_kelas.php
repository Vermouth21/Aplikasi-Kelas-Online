            ...
            <div style="margin-top:10px;">
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="kode_kelas" type="text" id="kode" class="form-control"
                             value='<?php echo $data['kode_kelas'];?>' readonly >
                        </div>
                    </div>
                   <div class="control-group">
                        <label class="control-label" for="nama">Nama Kelas</label>
                        <div class="controls">
                        	<input name="nama_kelas" type="text" id="nama" 
                        	value='<?php echo $data['nama_kelas'];?>' class="form-control">
                        </div>
                    </div>
