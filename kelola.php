	...
	<div class="page">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				$s = mysql_query("SELECT * FROM pelanggaran_siswa ORDER BY tgl_pelanggaran ASC");
				...
				<div>
					...
					<div style="margin-top:10px" class="text-right">
						<a href="tambah_pelanggaranSiswa.php"><input name="tambah" type="submit" id="tambah" value="Tambah Data" class="btn btn-primary"></a>
					</div>
					<div style="margin-top:10px">
						<table class="table table-condensed table-bordered table-hover">
							...
							while ($data = mysql_fetch_array($s)) {
								...
								$query = mysql_query("Select * from jenis_pelanggaran where kode_pelanggaran='$data[kode_pelanggaran]'");
								$jens = mysql_fetch_array($query);
							...
							?>
								<tbody align="center">
									...
									<td>
										...
										<a class="btn btn-small btn-info" href="edit_pelanggaranSiswa.php?kode=<?php echo $data['id_plg_siswa']; ?>" title="Edit"> Edit</a>

										<a class="btn btn-small btn-warning" href="hapus_pelanggaranSiswa.php?kode=<?php echo $data['id_plg_siswa']; ?>" d title="Hapus">Hapus</a>
