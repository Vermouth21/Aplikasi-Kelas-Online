    ...
    <tr>
      ...
      <td align="justify" ><img width='100%' src='images/sekolah.png'></td>
                    ...
                    <thead>
                      ...
                      <td  align="center"><font face="Times New Roman, cursive" class="text-error text-center"><h5>Bobot</h5></font>
                      </td>
                    ...
                    <?php 
          $i = 1;
  $data = mysql_query("SELECT * from pelanggaran_siswa,siswa,jenis_pelanggaran,kelas where pelanggaran_siswa.nis=siswa.nis and pelanggaran_siswa.kode_pelanggaran=jenis_pelanggaran.kode_pelanggaran and siswa.kode_kelas=kelas.kode_kelas");
