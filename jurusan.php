...
<?php
	...
	$i = 1;
		...
		$s = mysql_query("select * from jurusan");
...
?>
			...
			<div>
            	...
            	<div style="margin-top:10px" class="text-right">
            		<a href="tambah_jurusan.php"><input name="tambah" type="submit" id="tambah" value="Tambah Data" class="btn btn-primary"></a>
                </div>
                <div style="margin-top:10px">
                    <table class="table table-condensed table-bordered table-hover">
                        ...
                        <td width="20%"><font face="Comic Sans MS, cursive" class="text-error text-center">
                          <h5>Kode Jurusan</h5></font></td>
                        <td width="20%"><font face="Comic Sans MS, cursive" class="text-error text-center">
                          <h5>Nama Jurusan</h5></font></td>
                    ...
                    <tbody align="center">
                    	 <td><?php echo $i ?></td>
                        <td>J-<?php echo $data['kode_jurusan'];?></td>
                        <td><?php echo $data['nama_jurusan'];?></td>
                      
                        <td>
                        	
                                <a class="btn btn-small btn-info" href="edit_jurusan.php?kode=<?php echo $data['kode_jurusan'];?>" 
                                    title="Edit"> Edit</a>
                               
                                <a class="btn btn-small btn-warning" href="hapus_jurusan.php?kode=<?php echo $data['kode_jurusan'];?>" d
                                    title="Hapus">Hapus</a>
