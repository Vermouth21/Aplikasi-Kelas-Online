            	...
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
            		...
            		<div class="control-group">
                     ...
                     <div class="control-group">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                        	<input name="catatan" type="text" id="nama" class="form-control">
                        </div>
                    </div>
                    ...
                    <?php
						if(isset($_POST['simpan'])){
							...
							mysql_query("insert into konseling (tgl,nis,catatan) values ('$_POST[tgl]','$_POST[nis]','$_POST[catatan]')");
