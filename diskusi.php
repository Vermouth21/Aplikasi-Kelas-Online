    ...
    <div class="page">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                $i = 1;
                $s = mysql_query("SELECT * FROM tb_diskusi");
                ...
                <div>
                    ...
                    <div style="margin-top:10px" class="text-right">
                        <a href="index.php?p=tambah_diskusi"><input name="tambah" type="submit" id="dataTable" value="Tambah Diskusi" class="btn btn-primary"></a>
                    </div>
                        ...
                        <table class="table table-condensed table-bordered table-hover">
                            ...
                            ?>
                                <tbody align="center">
                                    ...
                                    <td>
                                        <a class="btn btn-small btn-danger" href="hapus_diskusi.php?id=<?php echo $data['id']; ?>" d title="Hapus">Hapus</a>
                                    </td>
                                </tbody>
                            <?php $i++;
                            } ?>
