...
<?php
	$kode	= $_GET['kode'];
	$sql	= mysql_query("select * from jenis_pelanggaran where kode_pelanggaran='$kode'");
	$data	= mysql_fetch_array($sql);
	if(mysql_num_rows($sql) > 0){
?>
			<div class="modal-header">
            	<h3>Edit Data Pelanggaran</h3>
            </div>
            <div style="margin-top:10px;">
            	<form class="form-horizontal" name="form1" method="post" action="" enctype="multipart/form-data">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input name="kode_pelanggaran" type="hidden" id="kode" class="form-control"
                             value='<?php echo $data['kode_pelanggaran'];?>' readonly >
                        </div>
                    </div>
                   <div class="control-group">
                        <label class="control-label" for="nama">Jenis</label>
                        <div class="controls">
                        	<input name="jenis" type="text" id="nama" 
                        	value='<?php echo $data['jenis'];?>' class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        	<input name="bobot" type="text" id="nama" 
                        	value='<?php echo $data['bobot'];?>' class="form-control">
                        </div>
                    </div>
                    ...
                    <?php }
						if(isset($_POST['update'])){
							...
							mysql_query("update jenis_pelanggaran set
											jenis= '$_POST[jenis]',
											bobot='$_POST[bobot]'
											where kode_pelanggaran='$_POST[kode_pelanggaran]'");
