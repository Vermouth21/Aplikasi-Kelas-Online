	...
	<div class="page">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				$i = 1;
				$s = mysql_query("SELECT * FROM tbl_barang");

				?>

				<div>
					<div class="modal-header">
						<h3>List Merchandise</h3>
					</div>
					<div style="margin-top:10px" class="text-right">
						<a href="tambah_merchan.php"><input name="tambah" type="submit" id="dataTable" value="Tambah Merchandise" class="btn btn-primary"></a>
					</div>
					<div style="margin-top:10px">
						<table class="table table-condensed table-bordered table-hover">
							...
							<?php
							$s = mysql_query("SELECT * FROM tbl_barang LEFT JOIN tbl_kategori ON tbl_barang.id_kategori=tbl_kategori.id_kategori");
							...
							?>
								<tbody align="center">
									...
									<td>
										<a class="btn btn-small btn-info" href="edit_merchan.php?id=<?php echo $data['id_barang']; ?>" title="Edit">Edit</a>
										<a class="btn btn-small btn-warning" href="hapus_merchan.php?id=<?php echo $data['id_barang']; ?>" d title="Hapus">Hapus</a>
									</td>
								</tbody>
							<?php $i++;
							} ?>
