        <?php
        $nagari = mysql_query("SELECT * from tbl_barang where nama_barang='$_GET[id]'");
        $sql = mysql_fetch_array($nagari);
        ?>
        <div class="row align-items-center py-5">
            <div class="col-sm-4 pl-sm-5 pr-sm-0">
                <div class="px-sm-5">
                    <div class="col-md-12 text-center">
                        <img class="img-responsive" src="images/<?php echo $sql['gambar']; ?>" width="300px" height="400px">
                    </div>
                </div>
            </div>
            <div class="col-sm-6 px-sm-5">
                ...
                <div class="wrapper-harga d-flex mt-3" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                    <div class="harga-awal h4 text-muted font-weight-semi-bold"><s><?php echo "Rp " . number_format($sql['harga_asli'], 2, ',', '.') ?></s></div>
                    <div class="harga-akhir h4 text-danger ml-4 font-weight-semi-bold"><span itemprop="price" content="85500"><?php echo "Rp " . number_format($sql['harga_diskon'], 2, ',', '.') ?></span></div>
                </div>
                ...
                <div class="custom-produk">
                    <form action="">
                        ...
                        <p class="">Stok : <span id="stock"><?php echo $sql['stok']; ?></span></p>
                        <a href="https://api.whatsapp.com/send?phone=6282170214495&text=Assalamualaikum, saya ingin membeli barang dengan nama barang <?php echo $_GET['id'] ?>" class="btn btn-primary">Pesan</a>
