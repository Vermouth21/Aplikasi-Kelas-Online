    ...
    <tr>
      ...
      <td align="justify" ><img width='100%' src='images/sekolah.png'></td>
                    ...
                    <thead>
                      ...
                      <td  align="center"><font face="Times New Roman, cursive" class="text-error text-center"><h5>Tanggal Konseling</h5></font>
                      </td>

                      <td  align="center"><font face="Times New Roman, cursive" class="text-error text-center"><h5>Catatan</h5></font>
                      </td>
                    ...
                    <?php 
          $i = 1;
  $data = mysql_query("SELECT * from konseling,siswa,kelas where konseling.nis=siswa.nis and siswa.kode_kelas=kelas.kode_kelas");
                    ...
                    <tbody>
                        ...
                        <td align="center"><?php echo $baris['nama_siswa'];?></td>
                         <td align="center"><?php echo $baris['nama_kelas'];?></td>
                          <td align="center"><?php echo $baris['tgl'];?></td>
                        <td align="center"><?php echo $baris['catatan'];?></td>
